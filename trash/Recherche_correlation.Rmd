...
RESTER SUR DES MODÈLES SIMPLES - comme ça c'est dis
...
us_accident <- read.csv("diabetes_binary_5050split_health_indicators_BRFSS2015.csv", stringsAsFactors = TRUE, skipNul = TRUE, na.strings = c(""), sep = ",")
```
...
Par exemple, dans notre base de données, on a 2 colones (start time et end time), on peut les fusioner en une variable "durée"
